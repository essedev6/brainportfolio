  ...
  return (
    <footer className="bg-gray-900 text-gray-300 py-8">
      <div className="container mx-auto px-6 text-center">
        <p className="text-sm mb-4">&copy; {new Date().getFullYear()} Brian Nyakoiro. All rights reserved.</p>
        <div className="flex justify-center space-x-6">
          ...
          <a href="https://www.linkedin.com/in/brian-nyakoiro-927428242/" className="hover:text-emerald-500"><FiLinkedin className="w-6 h-6" /></a>
        </div>
        <div className="mt-4">
